        ...
        public void run() {
            try {
                ...
                while ((clientMessage = in.readLine()) != null) {
                    ...
                    out.println("Сообщение от клиента" + c + ": Текущая дата: " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + clientMessage);
                    System.out.println("Текущая дата: " + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + " + Сообщение от клиента" + c + ": " + clientMessage);
                }
